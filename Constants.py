...
CSV_COOLDOWN = 1 # Cuantos pasos deben pasar para que volver a escribir en un .csv
...
'''
STEPS_PER_EPISODE = 250   # Número de pasos máximo a simular en un episodio
NUMBER_OF_EPISODES = 500 # Número de episodios a simular
